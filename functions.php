...
/** add custom FAQ plugin */

function custom_register_FAQ_post_type() {
	$labels = array(
		'name' => 'FAQ',
		'singular_name' => 'FAQ',
		'add_new' => 'Add New FAQ',
	...
	$args = array(
		...
		'has_archive' => true,
		'hierarchical' => false,
		'menu_icon' => get_stylesheet_directory_uri() . '/images/icons/users_16.png',
		'menu_position' => 5,
		'supports' => array('title','author','editor','thumbnail','excerpt','trackbacks','custom-fields','revisions','page-attributes','post-formats','genesis-cpt-archives-settings')
...
add_action( 'init', 'custom_register_FAQ_post_type' );